...
function loadState() {
  ...
  try {
    ...
    if (data.blockedServerFPs)    data.blockedServerFPs.forEach(fp => blockedServerFPs.add(fp));
...
// ─── Server Fingerprint Blocking (terminal/script attacks) ──────────────────
